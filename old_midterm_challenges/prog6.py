...
#    '''
#    # Your code here
# https://github.com/OllieGitHub1/MITx-6.00.1x-/blob/master/Midterm_Exam/Problem_7.py
# https://github.com/anarayanan86/MITx-6.00.1x/blob/master/Midterm_Exam/Problem_7.py
# https://github.com/dlujHub/MITx-6.00.1x-Introduction-to-Computer-Science-and-Programming-Using-Python/blob/master/Midterm_Exam/Problem_7.py
