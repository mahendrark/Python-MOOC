...
# For example, if listA = [1, 2, 3] and listB = [4, 5, 6], the dot product is
...
#     '''
#     # Your code here
# https://github.com/OllieGitHub1/MITx-6.00.1x-/blob/master/Midterm_Exam/Problem_5.py#L3
# https://github.com/dlujHub/MITx-6.00.1x-Introduction-to-Computer-Science-and-Programming-Using-Python/blob/master/Midterm_Exam/Problem_5.py
