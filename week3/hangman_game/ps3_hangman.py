...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    actualLetters = list(secretWord) # list of letters in the secretWord
    print("I am thinking of a word that is "+str(wordlen)+" letters long.")
    
    numofGuesses = 8
    lettersGuessed = []
    
    while numofGuesses > 0 or (isWordGuessed(secretWord, lettersGuessed)==True):
        ...
        if inputLetter in actualLetters:
            if inputLetter not in lettersGuessed:
                lettersGuessed = lettersGuessed.append(inputLetter)
